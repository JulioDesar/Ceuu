...
<nav class="fixed left-0 top-0 h-screen w-64 bg-slate-900 border-r border-slate-700 flex flex-col overflow-y-auto z-50">
    ...
    <div class="flex-1 py-4">
        <a href="/" class="flex items-center space-x-3 px-6 py-3 text-gray-300 hover:bg-slate-800 hover:text-blue-400 transition">
    ...
    <div class="border-t border-slate-700 p-4">
        <a href="#" class="flex items-center space-x-3 px-2 py-3 text-gray-300 hover:bg-slate-800 hover:text-blue-400 transition rounded-lg">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="#" class="flex items-center space-x-3 px-2 py-3 mt-2 text-gray-300 hover:bg-slate-800 hover:text-blue-400 transition rounded-lg">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
